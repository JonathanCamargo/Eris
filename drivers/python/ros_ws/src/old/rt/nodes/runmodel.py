...
model=loadedData['m']
#vecsize=int(eng.size(eng.getfield(model,'X'),2))
print(model)
vecsize=int(2)
...
classpub = rospy.Publisher('/eris/Class', String, queue_size=1)
...
feature_sub = rospy.Subscriber('/eris/Features', Float32MultiArray, predict)
