 ...
 */
#ifndef HardwareSerialCommand_h
#define HardwareSerialCommand_h
...
#define HWSERIAL Serial2 //Change this according to the arduino ports
...
class HardwareSerialCommand {
  public:
    HardwareSerialCommand();      // Constructor
