...
struct FilterOnePole {
  ...
  FilterOnePole( FILTER_TYPE ft=LOWPASS, float fc=1.0, float initialValue=0, float constantSPS=-1);
  
  // sets or resets the parameters and state of the filter
  void setFilter( FILTER_TYPE ft, float tauS, float initialValue,float constantSPS );
