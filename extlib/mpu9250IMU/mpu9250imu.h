...
#ifndef MPU9250IMU_teensy_lib_v2_h
#define MPU9250IMU_teensy_lib_v2_h
...
#define MPU9250IMU_BUFFERSIZE 10

#define SPISETTINGS SPISettings(500000, MSBFIRST, SPI_MODE0)
