...
from custom_msgs.msg import EMG8CH, String, Float32, Bool, Float32MultiArray 
...
emgformat=Struct(
    "len" / Int8ub,
    "emgdata" / Array(this.len,EMGSample_t)
)
...
emgpub = rospy.Publisher('/record/eris/emg', EMG8CH, queue_size=100)
...
streamsformat=[sineformat,emgformat,fsrformat]
