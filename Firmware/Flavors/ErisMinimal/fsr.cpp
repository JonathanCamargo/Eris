...
static const uint8_t pin_channels[FSR_NUMCHANNELS]={PIN_FSR_0,PIN_FSR_1};
...
ERIS_THREAD_WA(waNewSample_T, ERIS_STACK_MEDIUM);
...
void start(void){
    ...
    newSample=eris_thread_create(waNewSample_T, ERIS_STACK_MEDIUM, ERIS_NORMAL_PRIORITY+1, NewSample_T, NULL);
  }
}
