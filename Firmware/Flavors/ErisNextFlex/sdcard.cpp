...
bool initSD(void){
   if (!SD.begin(chipSelect)) {
      eriscommon::print("initialization failed. Things to check:");
      eriscommon::print("* is a card inserted?");
      eriscommon::print("* is your wiring correct?");
      eriscommon::print("* did you change the chipSelect pin to match your shield or module?"); 
      return false;
    } else {
     eriscommon::print("SD card is present."); 
     isSDOK = true;
     return true;
    }    
}
