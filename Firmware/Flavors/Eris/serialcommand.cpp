...
static void printFSRFields(const FSRSample_t& s) {
    Serial.print(s.ch[0], 2);   // single channel display matches original behavior
}

static void printSyncFields(const uint8_tSample_t& s) {
