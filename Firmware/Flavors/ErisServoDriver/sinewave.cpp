...
ERIS_THREAD_WA(waGenerateWave_T, ERIS_STACK_MEDIUM);
ERIS_THREAD_FUNC(GenerateWave_T) {
  ...
  while(1){
    ...
    generateWave=eris_thread_create(waGenerateWave_T, ERIS_STACK_MEDIUM, ERIS_NORMAL_PRIORITY+1, GenerateWave_T, NULL);
	}
